...
namespace AnimLib.Animations {
  ...
  public readonly struct SwitchTextureFrame : IFrame {
    /// <summary>
    /// Creates a <see cref="SwitchTextureFrame"/> with the given X and Y position, frame duration, and spritesheet. These values will be cast to smaller data types.
    /// </summary>
    ...
    /// The first texture replacenemt cannot be a <see langword="null"/> value.</param>
    ...
    /// <param name="texturePath">Spritesheet that this track will switch to upon reaching this frame, -or- <see langword="null"/> to use the <see cref="AnimationSource"/>'s texture.</param>
    ...
    /// <summary>
    /// Returns a <see cref="string"/> containing the X and Y value of the <see cref="tile"/>, the <see cref="duration"/>, and the <see cref="texturePath"/> of this instance.
    /// </summary>
    /// <returns>A <see cref="string"/> containing the X and Y value of the <see cref="tile"/>, the <see cref="duration"/>, and the <see cref="texturePath"/>.</returns>
    public override string ToString() => $"x:{tile.X}, y:{tile.Y}, duration:{duration}, texturePath{(texturePath is null ? " is null" : (": " + texturePath))}";
  }
}
